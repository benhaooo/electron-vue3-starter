    ...
    <div class="card mb-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <div class="space-y-2">
            <button class="btn btn-secondary w-full" @click="minimizeWindow">
              Minimize Window
            </button>
            <button class="btn btn-secondary w-full" @click="maximizeWindow">
              Toggle Maximize
            </button>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="space-y-2">
            <button class="btn btn-primary w-full" @click="showInfoDialog">
              Show Info Dialog
            </button>
            <button class="btn btn-secondary w-full" @click="showWarningDialog">
              Show Warning Dialog
            </button>
          </div>
        </div>
    ...
    <div class="card mb-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <button class="btn btn-secondary mt-2 w-full" @click="resetCounter">
            Reset
          </button>
        </div>
